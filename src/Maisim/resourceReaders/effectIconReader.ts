...
import baseline_unfold_more_black_24dp_icon from '../../resource/maimai_img/effect/baseline_unfold_more_black_24dp.png';
...
import just_curv_l_icon from '../../resource/maimai_img/effect/just_curv_l.png';
import just_curv_r_icon from '../../resource/maimai_img/effect/just_curv_r.png';
import Just_str_icon from '../../resource/maimai_img/effect/Just_str.png';
import just_str_l_icon from '../../resource/maimai_img/effect/just_str_l.png';
import just_str_r_icon from '../../resource/maimai_img/effect/just_str_r.png';
import Just_wifi_icon from '../../resource/maimai_img/effect/Just_wifi.png';
import just_wifi_d_icon from '../../resource/maimai_img/effect/just_wifi_d.png';
import just_wifi_u_icon from '../../resource/maimai_img/effect/just_wifi_u.png';
...
import outline_fullscreen_white_24dp_icon from '../../resource/maimai_img/effect/outline_fullscreen_white_24dp.png';
...
export const EffectIcon = {
    baseline_unfold_more_black_24dp: new Image(),
    BreakLine: new Image(),
    Circle: new Image(),
    EachLine: new Image(),
    EachLine1: new Image(),
    ...
    Hex: new Image(),
    Just_curv: new Image(),
    just_curv_l: new Image(),
    just_curv_r: new Image(),
    Just_str: new Image(),
    just_str_l: new Image(),
    just_str_r: new Image(),
    Just_wifi: new Image(),
    just_wifi_d: new Image(),
    just_wifi_u: new Image(),
    mask: new Image(),
    NormalLine: new Image(),
    outline_fullscreen_white_24dp: new Image(),
    SlideLine: new Image(),
    StarWhite: new Image(),
...
export const initeffecticons = (onload: () => void) => {
  ...
  EffectIcon.Just_curv.src = Just_curv_icon;
  EffectIcon.Just_curv.onload = () => { loaded++; if (loaded >= amount) onload(); }
  EffectIcon.just_curv_l.src = just_curv_l_icon;
  EffectIcon.just_curv_l.onload = () => { loaded++; if (loaded >= amount) onload(); }
  EffectIcon.just_curv_r.src = just_curv_r_icon;
  EffectIcon.just_curv_r.onload = () => { loaded++; if (loaded >= amount) onload(); }
  EffectIcon.Just_str.src = Just_str_icon;
  EffectIcon.Just_str.onload = () => { loaded++; if (loaded >= amount) onload(); }
  EffectIcon.just_str_l.src = just_str_l_icon;
  EffectIcon.just_str_l.onload = () => { loaded++; if (loaded >= amount) onload(); }
  EffectIcon.just_str_r.src = just_str_r_icon;
  EffectIcon.just_str_r.onload = () => { loaded++; if (loaded >= amount) onload(); }
  EffectIcon.Just_wifi.src = Just_wifi_icon;
  EffectIcon.Just_wifi.onload = () => { loaded++; if (loaded >= amount) onload(); }
  EffectIcon.just_wifi_d.src = just_wifi_d_icon;
  EffectIcon.just_wifi_d.onload = () => { loaded++; if (loaded >= amount) onload(); }
  EffectIcon.just_wifi_u.src = just_wifi_u_icon;
  EffectIcon.just_wifi_u.onload = () => { loaded++; if (loaded >= amount) onload(); }
  ...
  EffectIcon.outline_fullscreen_white_24dp.src = outline_fullscreen_white_24dp_icon;
  EffectIcon.outline_fullscreen_white_24dp.onload = () => { loaded++; if (loaded >= amount) onload(); }
